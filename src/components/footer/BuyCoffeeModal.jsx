...
import { Modal, Grid, Divider, Tab } from 'semantic-ui-react';
      ...
      render: () => (
        <Tab.Pane attached={false}>
          ...
          >
            ...
            <img src='./beemit.jpg' alt='beemit' width='80px' height='80px' />
          </div>
        </Tab.Pane>
      )
    },
      ...
      <Modal.Content>
        <Modal.Description>
           ...
           */}
            ...
            <Grid.Row>
              <p>
                Thank you for your support, so far we got {sponsor.AUD} AUD and{' '}
                {sponsor.CNY} CNY, details see:{' '}
                <a
                  target='_blank'
                  rel='noopener noreferrer'
